...
%% load response data
load('Charleston_CSRM_Subset_Output_WithTides.mat')       % Response 'Resp' and Indicator matrix 'Ind_wet' telling whether node is wet or dry
...
load('Charleston_CSRM_Subset_Grid.mat')
...
load('SACS_NCSFL_HC_tbl_ATC_SWL_SLC0.mat', 'HC_tbl_ATC_SWL_SLC0')
load('AEF22.mat', 'tbl_aef')
