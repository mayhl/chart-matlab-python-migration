...
plot_folder = '/Users/rdchlmyl/Desktop/v17Dec2024_TCselection/Plots';
if ~exist(plot_folder,'dir'); mkdir(plot_folder); end

%% LOAD Savepoints
SPs_all = dload('./Inputs_Processed/Savepoints.mat');
...
M = readmatrix('Sponsor_Selected_2025-03-03.csv');
selected_IDs = [M(:,3)' , ...
...
% Export Plots
savefig(gcf,fullfile(plot_folder,[fname,'.fig']),'compact')
